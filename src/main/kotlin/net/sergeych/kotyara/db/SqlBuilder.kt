...
//
///**
// * This is a future class for serialized-base resultset interpretation
// */
//class SqlBuilder<T : Any>(
...
//     * @return self
//     */
//    fun where(whereClause: String, vararg params: Any): SqlBuilder<T> {
...
//     */
//    fun addJoin(clause: String): SqlBuilder<T> {
//        joins.add(clause)
//        return this
//    }
//
...
//     * @return self
//     */
//    fun where(vararg pairs: Pair<String, Any?>): SqlBuilder<T> {
...
//    }
//
//    fun order(orderBy: String): SqlBuilder<T> {
//        order.add(orderBy)
//        return this
//    }
//
//    fun limit(value: Int): SqlBuilder<T> {
//        dropCache(); _limit = value
//        return this
//    }
//
//    fun offset(value: Int): SqlBuilder<T> {
